          ...
          {isSuccess ? (
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center justify-center gap-4 text-xs font-semibold select-none">
                <div
                  className={`flex items-center gap-1.5 ${step >= 1
                      ? isGoatTheme
                        ? "text-goat-primary"
                        : "text-mutton-primary"
                      : "text-neutral-400"
                ...
                >
                  <span
                    className={`w-6 h-6 rounded-full flex items-center justify-center border font-bold ${step >= 1
                        ? isGoatTheme
                ...
                <div className={`flex items-center gap-1.5 ${step === 2 ? (isGoatTheme ? "text-goat-primary" : "text-mutton-primary") : "text-neutral-400"}`}>
                  <span
                    className={`w-6 h-6 rounded-full flex items-center justify-center border font-bold ${step === 2
                        ? isGoatTheme
                          ? "bg-goat-tint border-goat-primary"
                          : "bg-mutton-tint border-mutton-primary"
                        : "border-neutral-300"
                  ...
                  <div className="space-y-6 animate-in fade-in duration-200">
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        <button
                          ...
                          className={`h-14 border rounded-xl flex items-center justify-center gap-2 font-bold text-sm transition-all cursor-pointer ${isGoatTheme
                    ...
                    <div className="space-y-1.5">
                      ...
                      <input
                        ...
                        min={1}
                        {...register("quantity")}
                        className={`w-full sm:max-w-xs h-11 bg-white border border-brand-border rounded-xl px-4 text-sm text-brand-black outline-none focus:ring-2 ${isGoatTheme ? "focus:ring-goat-primary" : "focus:ring-mutton-primary"
                          }`}
                      />
                      {errors.quantity && (
                        <p className="text-xs text-red-600 font-semibold flex items-center gap-1 mt-1">
                    ...
                    <div className="border-t border-brand-border pt-6 flex justify-end">
                      <button
                        ...
                        className={`inline-flex items-center gap-2 h-11 px-4 md:px-6 font-semibold text-sm rounded-xl text-white transition-colors cursor-pointer ${isGoatTheme
                  ...
                  <div className="space-y-6 animate-in fade-in duration-200">
                      ...
                      <div className="space-y-1.5">
                        ...
                        <div className="relative">
                          ...
                          <input
                            ...
                            className={`w-full h-11 bg-white border border-brand-border rounded-xl pl-10 pr-4 text-sm text-brand-black outline-none focus:ring-2 ${isGoatTheme ? "focus:ring-goat-primary" : "focus:ring-mutton-primary"
                              }`}
                          />
                        </div>
                        {errors.customerName && (
                    ...
                    <div className="space-y-1.5">
                      ...
                      <textarea
                        ...
                        className={`w-full bg-white border border-brand-border rounded-xl p-3 md:p-4 text-sm text-brand-black outline-none focus:ring-2 resize-none ${isGoatTheme ? "focus:ring-goat-primary" : "focus:ring-mutton-primary"
                          }`}
                      ></textarea>
                    ...
                    <div className="space-y-1.5">
                      ...
                      <div className="relative">
                        ...
                        <textarea
                          ...
                          className={`w-full bg-white border border-brand-border rounded-xl pl-10 pr-4 py-3 text-sm text-brand-black outline-none focus:ring-2 resize-none ${isGoatTheme ? "focus:ring-goat-primary" : "focus:ring-mutton-primary"
                            }`}
                        ></textarea>
                      </div>
                    </div>
                    ...
                    <div className="border-t border-brand-border pt-6 flex justify-between items-center">
                      ...
                      <button
                        ...
                        className={`inline-flex items-center justify-center gap-2 h-11 px-7 font-semibold text-sm rounded-xl text-white transition-colors disabled:opacity-50 cursor-pointer ${isGoatTheme
                            ? "bg-goat-primary hover:bg-goat-hover"
                            : "bg-mutton-primary hover:bg-mutton-hover"
                          }`}
                      >
