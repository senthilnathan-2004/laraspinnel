...
import { Loader2, ArrowLeft, Save, AlertCircle, FileText } from "lucide-react";
...
export default function EditBlogPostPage() {
      ...
      try {
        ...
        if (res.ok) {
          ...
          if (item) {
            ...
            setCoverImage(item.coverImage ? [item.coverImage] : []);
  ...
  return (
    <div className="flex-1 flex flex-col min-h-screen">
      <AdminTopbar title="Edit Article" />
          ...
          <form onSubmit={handleSubmit} className="bg-white border border-brand-border rounded-2xl shadow-card p-3 md:p-6 space-y-6 animate-in fade-in duration-200" noValidate>
            ...
            <div className="flex items-center gap-6 border-t border-brand-border pt-6">
              <label className="flex items-center gap-2.5 cursor-pointer">
                ...
                />
                <span className="text-sm font-semibold text-brand-black">Published</span>
              </label>
            </div>
